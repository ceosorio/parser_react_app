...
function App() {
  ...
  const ListLoadingC = ListLoading(PutList)
  ...
  function Pages(appState){
    
    return (
      <div className={classes.bg}>
        <Button component="span" color="primary" disabled={!appState.previous} onClick={() => setPage(page - 1)}>
          Previous
        </Button>
        <Button component="span" color='primary' disabled={!appState.next} onClick={() => setPage(page + 1)}>
          Next
        </Button>
      </div>
    )
  ...
  useEffect(() => {
    fetch(`https://swapi.dev/api/people/?page=${page}`)
      .then((res) => res.json())
      .then((items) => {
        setAppState({ loading: false, items: items.results, next: items.next, previous: items.previous})
      })
  }, [page]) 
  ...
  return (
    <div className={classes.bg}>
      <Container maxWidth="sm" className={classes.bg}>
        ...
        <div>
              <svg viewBox="0 0 1347.6 227.4" class={classes.logo}><g id="Logo">
        ...
        <Container maxWidth="sm" className={classes.bg}>
            <div>
            <ListLoadingC isLoading={appState.loading} items={appState.items} />
            {Pages(appState)}
